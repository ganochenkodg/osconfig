...
func TestScalibrBenchmark(t *testing.T) {
	benchmarks := []struct {
		...
		{label: "Base OS Only", extractors: []string{"os/dpkg", "os/rpm", "os/cos"}},
		{label: "+ python/wheelegg", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "python/wheelegg"}},
		{label: "+ python/uvlock", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "python/uvlock"}},
		{label: "+ ruby/gemspec", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "ruby/gemspec"}},
		{label: "+ javascript/packagejson", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "javascript/packagejson"}},
		{label: "+ java/archive", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "java/archive"}},
		{label: "+ java/pomxml", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "java/pomxml"}},
		{label: "+ java/gradlelockfile", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "java/gradlelockfile"}},
		{label: "+ go/binary", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "go/binary"}},
		{label: "+ go/gomod", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "go/gomod"}},
		{label: "+ rust/cargolock", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "rust/cargolock"}},
		{label: "+ rust/cargoauditable", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "rust/cargoauditable"}},
		{label: "+ php/composerlock", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "php/composerlock"}},
		{label: "+ swift/packageresolved", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "swift/packageresolved"}},
		{label: "+ dart/pubspec", extractors: []string{"os/dpkg", "os/rpm", "os/cos", "dart/pubspec"}},
		{
			label: "All Selected Combined",
			extractors: []string{
				"os/dpkg", "os/rpm", "os/cos",
				"python/wheelegg", "python/uvlock", "ruby/gemspec", "javascript/packagejson",
				"java/archive", "java/pomxml", "java/gradlelockfile", "go/binary", "go/gomod",
				"rust/cargolock", "rust/cargoauditable", "php/composerlock", "swift/packageresolved", "dart/pubspec",
			},
		},
	}
